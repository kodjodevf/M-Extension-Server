package eu.kanade.tachiyomi.torrentutils.bencode
...
sealed interface BencodeValue {
    ...
    data class List(
        val value: kotlin.collections.List<BencodeValue>,
    ) : BencodeValue

    data class Dictionary(
        val value: SortedMap<ByteString, BencodeValue>,
    ) : BencodeValue {
        fun getByString(key: String): BencodeValue? = this.value[ByteString.fromUTF8String(key)]
    }
}
